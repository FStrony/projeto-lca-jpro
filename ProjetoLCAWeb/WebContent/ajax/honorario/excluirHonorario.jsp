...
AdvocaciaNegocio.excluirHonorario(Integer.parseInt(id));
out.println("<script>alert('Honorario excluído com sucesso!')</script>");
out.println("<script>location.href=\"/ProjetoLCAWeb/honorario\"</script>");
%>