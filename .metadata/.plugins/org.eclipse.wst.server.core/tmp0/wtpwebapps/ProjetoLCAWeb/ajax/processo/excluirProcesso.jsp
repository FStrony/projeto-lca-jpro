...
AdvocaciaNegocio.excluirProcesso(Integer.parseInt(id));
out.println("<script>alert('Processo excluído com sucesso!')</script>");
out.println("<script>location.href=\"/ProjetoLCAWeb/processo\"</script>");
%>